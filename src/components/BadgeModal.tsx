...
const BadgeModal: React.FC = () => {
  ...
  return (
    ...
    >
      <div className="modern-card max-w-lg w-full p-6 animate-scaleIn relative">
        {/* Close Button */}
        <button
        ...
        <div className="text-center">
          {/* Large Badge Icon */}
          <div className={`inline-block p-6 rounded-2xl border-4 ${getRarityColor(selectedBadge.rarity)} modern-glow-strong mb-4 relative overflow-hidden`}>
            {/* Rarity glow effect */}
          ...
          {/* Badge Info */}
          <h2 className="text-2xl font-bold text-white mb-2 modern-gradient-text">
            {selectedBadge.name}
          </h2>
          
          <p className="text-white/80 text-base mb-4 leading-relaxed max-w-md mx-auto">
            {selectedBadge.description}
          </p>
          
          {/* Badge Details */}
          <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
            <div className="modern-card p-3 bg-white/5">
              <div className="flex items-center justify-center mb-2">
                <Star className={`${getRarityTextColor(selectedBadge.rarity)}`} size={18} />
              </div>
              <div className="text-white/60 text-xs mb-1">Rarity</div>
              <div className={`font-bold text-sm capitalize ${getRarityTextColor(selectedBadge.rarity)}`}>
          ...
          {/* Achievement Message */}
          <div className="modern-card p-4 bg-white/5 border-l-4 border-white mb-4">
            <h3 className="text-white font-bold mb-2 text-sm">🏆 Achievement Unlocked!</h3>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <button
              ...
              className="modern-button-secondary px-4 py-2 text-sm font-semibold hover-lift flex items-center justify-center"
            >
            ...
            <button
              onClick={closeBadgeModal}
              className="modern-button px-4 py-2 text-sm font-semibold hover-lift"
            >
              Awesome!
            </button>
          </div>
