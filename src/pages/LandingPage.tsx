  ...
  return (
    <div className="min-h-screen bg-pattern relative overflow-hidden">
      ...
      <div className="container mx-auto px-6 py-20 text-center text-white relative z-10">
        <div className="flex justify-center mb-12 animate-scaleIn">
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-r from-purple-500/30 to-pink-500/30 rounded-full blur-3xl animate-pulse-slow"></div>
            <img 
              src="/pic.png"
        ...
        <div className="mb-8 animate-fadeIn">
          <div className="inline-flex items-center space-x-2 glass-card rounded-full px-6 py-3 mb-6 glow-border">
            <Star size={16} className="text-yellow-400 animate-pulse" />
            <span className="text-gradient-purple font-semibold">South Africa's Premier Coding Competition</span>
            <Star size={16} className="text-yellow-400 animate-pulse" />
          </div>
        </div>
        ...
        <h1 className="text-6xl md:text-8xl font-black mb-8 text-shadow animate-fadeIn">
          ...
          <br />
          <span className="text-gradient">CODE CUP</span>
        </h1>
        ...
        <div className="flex flex-col md:flex-row justify-center gap-6 mb-20 animate-fadeIn">
          {currentUser ? (
            <Link 
              to="/dashboard" 
              className="btn-primary px-8 py-4 rounded-2xl flex items-center justify-center text-lg font-bold hover-lift"
            >
          ...
          <Link 
            to="/leaderboard" 
            className="btn-secondary px-8 py-4 rounded-2xl flex items-center justify-center text-lg font-bold hover-lift"
          >
        ...
        {/* Challenge Info */}
        <div className="neon-card rounded-3xl max-w-6xl mx-auto mb-20 p-8 animate-scaleIn hover-lift">
          <div className="flex items-center justify-center mb-8">
            <div className="p-4 bg-gradient-to-r from-purple-500/20 to-pink-500/20 rounded-2xl mr-4 animate-glow">
              <Cpu className="text-gradient-purple" size={40} />
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="glass-card rounded-2xl p-6 hover-lift border border-green-500/30">
            ...
            <div className="glass-card rounded-2xl p-6 hover-lift border border-red-500/30">
              <div className="flex items-center mb-4">
            ...
            <div className="glass-card rounded-2xl p-6 hover-lift border border-purple-500/30">
              <div className="flex items-center mb-4">
                <div className="p-3 bg-purple-500/20 rounded-xl mr-4">
                  <Code2 size={24} className="text-purple-400" />
                </div>
                <div>
                  <p className="font-bold text-purple-400 text-lg">Total Problems</p>
      ...
      <div className="container mx-auto px-6 py-20 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="gradient-card rounded-3xl p-8 text-center group hover-lift">
            <div className="flex justify-center mb-6">
              <div className="p-6 bg-gradient-to-r from-blue-500/20 to-purple-500/20 rounded-2xl group-hover:scale-110 transition-all duration-300">
                <University size={48} className="text-gradient-purple" />
              </div>
            </div>
          ...
          <div className="gradient-card rounded-3xl p-8 text-center group hover-lift">
            <div className="flex justify-center mb-6">
              <div className="p-6 bg-gradient-to-r from-green-500/20 to-blue-500/20 rounded-2xl group-hover:scale-110 transition-all duration-300">
          ...
          <div className="gradient-card rounded-3xl p-8 text-center group hover-lift">
            <div className="flex justify-center mb-6">
              <div className="p-6 bg-gradient-to-r from-yellow-500/20 to-orange-500/20 rounded-2xl group-hover:scale-110 transition-all duration-300">
                <Award size={48} className="text-gradient-orange" />
              </div>
            </div>
            <h3 className="text-2xl font-bold mb-4 text-gradient-orange">
              Recognition & Prizes
            </h3>
            <p className="text-gray-300 leading-relaxed">
      ...
      {/* Stats Section */}
      <div className="container mx-auto px-6 py-20 relative z-10">
        <div className="neon-card rounded-3xl p-12 hover-lift">
          <h3 className="text-3xl font-bold text-center text-gradient mb-12">Competition Statistics</h3>
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div className="group">
              <div className="text-5xl font-black text-gradient-purple mb-3 group-hover:scale-110 transition-transform duration-300">24+</div>
            ...
            <div className="group">
              <div className="text-5xl font-black text-gradient-orange mb-3 group-hover:scale-110 transition-transform duration-300">4</div>
